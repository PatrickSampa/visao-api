    ...
    for (let idexDoBeneficio = 0; idexDoBeneficio < beneficios.length; idexDoBeneficio++) {
        for (let idexDaDivParaPesquisarAtabela = numeroInicialParaProcurarAPosiçaoDasDivDaTabelaDeBeneficio; idexDaDivParaPesquisarAtabela <= numeroMaximoParaProcurarAPosiçaoDasDivDaTabelaDeBeneficio; idexDaDivParaPesquisarAtabela++) {
            for (let indexDaTabela = numeroInicialParaProcurarATabelaDoBeneeficio; indexDaTabela <= numeroMaxioParaProcurarATabelaDoBeneeficio; indexDaTabela++) {
                const xpathNbDaTabela = "/html/body/div/div[" + idexDaDivParaPesquisarAtabela + "]/div[" + indexDaTabela + "]/table[1]/tbody/tr/td[2]"
                const nb = getXPathText(paginaHTML_DOSPREV_Formatada, xpathNbDaTabela);
                let especieDifenteDoBeneficio;

                const xpathEspecie = "html/body/div/div[" + idexDaDivParaPesquisarAtabela + "]/div[" + indexDaTabela + "]/table[1]/tbody/tr/td[3]"
                const especie = getXPathText(paginaHTML_DOSPREV_Formatada, xpathEspecie);
                ...
                const nb_EstaDiferenteDoBeneficio = nb.trim() != beneficios[idexDoBeneficio].nb;
                ...
                const xphatRMI = "/html/body/div/div[" + idexDaDivParaPesquisarAtabela + "]/div[" + indexDaTabela + "]/table[2]/tbody/tr/td[1]"
                ...
                const xpathDIP = "/html/body/div/div[" + idexDaDivParaPesquisarAtabela + "]/div[" + indexDaTabela + "]/table[1]/tbody/tr/td[8]"
                ...
                const xpathDibAnterior = "/html/body/div/div[" + idexDaDivParaPesquisarAtabela + "]/div[" + indexDaTabela + "]/table[2]/tbody/tr/td[6]"
